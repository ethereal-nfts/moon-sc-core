...
contract MoonPresale is Initializable, Ownable {
    ...
    ERC20Mintable private moonToken;
    ...
    function initialize(
        ...
        require(moonToken.balanceOf(address(this)) == totalPresaleTokens.add(totalUniswapTokens));
        moonToken.approve(address(uniswapRouter), totalUniswapTokens);
